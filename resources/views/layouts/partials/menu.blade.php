<!-- Aca esta el logo de la empresa -->
<nav class="navbar default-layout col-lg-12 col-12 p-0 fixed-top d-flex align-items-top flex-row">
    ...
    <!-- Zona donde aparece el nombre del usuario con la imagen de usuario -->
    <div class="navbar-menu-wrapper d-flex align-items-top">
        <ul class="navbar-nav">
            <li class="nav-item font-weight-semibold d-none d-lg-block ms-0">
                <h1 class="welcome-text">Bienvenido, <span class="text-black fw-bold"> {{ Auth::user()->name
                        }}</span></h1>
            </li>
        </ul>
...
<!-- Aca termina la zona de navbar de arriba de la pagina -->